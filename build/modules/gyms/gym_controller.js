...
export const addGymHandler = async (req, res) => {
    console.log("ADD GYM!!!!");
    try {
...
export const getAllGymsHandler = async (req, res) => {
    try {
...
export const getGymByIdHandler = async (req, res) => {
    try {
...
export const updateGymHandler = async (req, res) => {
    try {
...
export const deleteGymHandler = async (req, res) => {
    try {
...
export const hideGymHandler = async (req, res) => {
    try {
        const { id } = req.params;
...
export const loginGymHandler = async (req, res) => {
    try {
...
export const refreshGymTokenHandler = async (req, res) => {
    try {
...
export const getCurrentGymHandler = async (req, res) => {
    try {
        // 日志方便排查
